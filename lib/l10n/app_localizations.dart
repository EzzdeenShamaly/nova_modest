...
abstract class AppLocalizations {
  ...
  /// The full terms and conditions, as one document. Approved by the owner on 2026-09-21. Every clause describes what the app and the database actually do; the commercial ones (returns window, delivery scope, governing law, age) are his decisions rather than drafted wording. Sections are numbered in the text and separated by blank lines, and the screen renders it as prose.
  ///
  /// In ar, this message translates to:
  ...
  /// The account-menu row, the dialog title and its destructive button. Last row of the menu, in the error colour (owner, 2026-09-21: Play requires deletion to be discoverable).
  ///
  /// In ar, this message translates to:
  /// **'حذف الحساب'**
  String get accountDelete;

  /// Shown before the shopper confirms. It must say what goes and what stays BEFORE she presses: orders survive because orders.user_id is ON DELETE SET NULL.
  ///
  /// In ar, this message translates to:
  ...
  /// delete-account refused with admin_account (403).
  ///
  /// In ar, this message translates to:
  /// **'حسابات الإدارة لا تُحذف من التطبيق.'**
  String get accountDeleteErrorAdmin;

  /// delete-account refused with avatar_delete_failed (502). The function stops before touching the account, so nothing changed.
  ///
  /// In ar, this message translates to:
  /// **'تعذّر حذف صورتكِ الشخصية، فلم يُحذف شيء. أعيدي المحاولة لاحقاً.'**
  String get accountDeleteErrorAvatar;

  /// delete-account refused with account_delete_failed (500). The photo is removed first, so by this point it is already gone: "nothing changed" would be false.
  ///
  /// In ar, this message translates to:
  /// **'تعذّر حذف الحساب، وقد حُذفت صورتكِ الشخصية. أعيدي المحاولة لاحقاً.'**
  String get accountDeleteErrorAccount;

  /// Any other delete-account code: not_configured, admin_check_failed, unexpected, method_not_allowed.
  ///
  /// In ar, this message translates to:
