...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get accountDeleteBody =>
      'Your account will be permanently deleted, together with your profile, your saved addresses and your photo. This cannot be undone.\n\nYour past orders stay with the shop, no longer linked to your account, including the name, phone and address recorded with each order.';
  ...
  String get accountDeleteErrorAvatar =>
      'Your photo could not be removed, so nothing was deleted. Please try again later.';

  @override
  String get accountDeleteErrorAccount =>
      'The account could not be deleted, though your photo has been removed. Please try again later.';

  @override
  String get accountDeleteErrorTechnical =>
      'The account could not be deleted because of a technical problem. Please try again later.';
}
