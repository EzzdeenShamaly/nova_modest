...
mixin _$ProductFeature {
 ...
 String get text;/// `fabric`, `fit`, `care`, … Unknown values fall back to a plain marker.
 String? get icon;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductFeature&&(identical(other.text, text) || other.text == text)&&(identical(other.icon, icon) || other.icon == icon));
}
...
@override
String toString() {
  return 'ProductFeature(text: $text, icon: $icon)';
}
...
/// Create a copy of ProductFeature
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? text = null,Object? icon = freezed,}) {
...
class _ProductFeature implements ProductFeature {
  const _ProductFeature({required this.text, this.icon});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductFeature&&(identical(other.text, text) || other.text == text)&&(identical(other.icon, icon) || other.icon == icon));
}
...
/// Create a copy of ProductFeature
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? text = null,Object? icon = freezed,}) {
