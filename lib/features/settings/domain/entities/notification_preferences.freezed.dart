...
/// default — it is what a shopper expects to be told about.
 bool get orders;/// Promotional. Off by default: marketing is opt-in, which is both the
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationPreferences&&(identical(other.orders, orders) || other.orders == orders)&&(identical(other.promotions, promotions) || other.promotions == promotions));
}


@override
int get hashCode => Object.hash(runtimeType,orders,promotions);

@override
String toString() {
  return 'NotificationPreferences(orders: $orders, promotions: $promotions)';
}
...
/// Create a copy of NotificationPreferences
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? orders = null,Object? promotions = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool orders,  bool promotions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationPreferences() when $default != null:
return $default(_that.orders,_that.promotions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool orders,  bool promotions)  $default,) {final _that = this;
switch (_that) {
case _NotificationPreferences():
return $default(_that.orders,_that.promotions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool orders,  bool promotions)?  $default,) {final _that = this;
switch (_that) {
case _NotificationPreferences() when $default != null:
return $default(_that.orders,_that.promotions);case _:
  return null;
...
class _NotificationPreferences implements NotificationPreferences {
  const _NotificationPreferences({this.orders = true, this.promotions = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotificationPreferences&&(identical(other.orders, orders) || other.orders == orders)&&(identical(other.promotions, promotions) || other.promotions == promotions));
}
...
/// Create a copy of NotificationPreferences
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? orders = null,Object? promotions = null,}) {
